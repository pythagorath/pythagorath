...
MASS_PAIRS = [(("التفاحة", "🍎"), ("البطيخة", "🍉")), (("البالون", "🎈"), ("الكتاب", "📚")),
              (("الريشة", "🪶"), ("الحجر", "🪨")), (("القلم", "✏️"), ("الكرسي", "🪑")),
              (("الفراشة", "🦋"), ("الفيل", "🐘")), (("ورقة", "📄"), ("الحقيبة", "🎒")),
              (("الكرة", "⚽"), ("الدرّاجة", "🚲")), (("الزهرة", "🌸"), ("القِدر", "🍲")),
              (("العصفور", "🐦"), ("البقرة", "🐄"))]
...
AREA_PAIRS = [("المنديل", "السجادة"), ("النافذة", "الباب"), ("الطابع", "الظرف"),
              ("البطاقة", "اللوحة"), ("الوسادة", "الفراش"), ("الصحن", "الطاولة"),
              ("الكتاب", "المكتب"), ("المرآة", "الجدار"), ("الورقة", "السبّورة")]
...
POS_SCENES = [("🌳", "الشجرة"), ("🪑", "الكرسي"), ("📦", "الصندوق"), ("🏠", "البيت"),
              ("🚗", "السيّارة"), ("🛏️", "السرير"), ("🧺", "السلّة")]
POS_OBJECTS = [("العصفور", "🐦"), ("القطة", "🐱"), ("الكرة", "⚽"), ("الأرنب", "🐰"),
               ("القبعة", "🎩"), ("الفراشة", "🦋"), ("النحلة", "🐝"), ("النجمة", "⭐"),
               ("البالون", "🎈")]
