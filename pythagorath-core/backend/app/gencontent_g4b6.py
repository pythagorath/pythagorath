...
CHOOSE = [("طول الملعب", "متر", "سنتيمتر"), ("طول القلم", "سنتيمتر", "متر"),
          ...
          ("طول النملة", "ملمتر", "متر"), ("ارتفاع الباب", "متر", "ملمتر"),
          ("كتلة الحافلة", "كيلوغرام", "غرام"), ("كتلة الريشة", "غرام", "كيلوغرام"),
          ("سعة قطرة الدواء", "مللتر", "لتر"), ("سعة حوض السباحة", "لتر", "مللتر"),
          ("طول السبّورة", "متر", "ملمتر"), ("كتلة حبّة الأرز", "غرام", "كيلوغرام")]
