...
EST_BANK = [("كتلة البطيخة", "٣ كغم", "٣٠٠ كغم"), ("سعة الكوب", "٢٠٠ مل", "٢٠ لتراً"),
            ...
            ("كتلة الفيل", "٣٠٠٠ كغم", "٣٠٠ غم"), ("سعة حوض الاستحمام", "١٥٠ لتراً", "١٥٠ مل"),
            ("كتلة الموزة", "١٢٠ غم", "١٢ كغم"), ("سعة قارورة العطر", "٣٠ مل", "٣٠ لتراً"),
            ("كتلة الدرّاجة", "١٢ كغم", "١٢ غم"), ("سعة إبريق الشاي", "١ لتر", "١٠٠ لتر"),
            ("كتلة الريشة", "١ غم", "١ كغم"), ("سعة ملعقة الدواء", "١٠ مل", "١٠ لترات")]
...
def capmass_measure(rng: random.Random, p: dict):
    ...
    n = rng.randrange(2, 9)                          # widened 2..8
